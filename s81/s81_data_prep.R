...
write.csv(indep_cols, "s81_indep.csv", row.names=F)
...
write.csv(generator, "s81_generator.csv", row.names=F)
...
write.csv(unique_lines, "s81_lines.csv", row.names=F)
...
write.csv(good_A, "s81_good_A.csv", row.names = FALSE)
