...
write.csv(indep_cols, "s16_indep.csv", row.names=F)
...
write.csv(generator, "s16_generator.csv", row.names=F)
...
write.csv(unique_lines, "s16_lines.csv", row.names=F)
...
write.csv(good_A, "s16_good_A.csv", row.names = FALSE)
